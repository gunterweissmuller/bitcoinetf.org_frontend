<template>
    <div id="performance-chart" class="w-chart-performance-fund">
      <div v-if="title" class="w-chart-performance-fund__caption">{{ title }}</div>
      
      <div class="w-chart-performance-fund__chart">
        <div class="w-chart-performance-fund__chart-ticker">Ticker:</div>
      ...
      y: {
        ...
        ticks: {
          ...
          callback: function(value) {
            ...
            return `${$app.filters.rounded(value/1000000, 1)}m`
          },
        },
        grid: {
          color: 'rgba(241,242,244, 0.04)',
          borderColor: 'rgba(241,242,244, 0.04)',
          display: true,
        },
      },
    },
  ...
  <style src="./w-chart-protection-fund.scss" lang="scss" />
