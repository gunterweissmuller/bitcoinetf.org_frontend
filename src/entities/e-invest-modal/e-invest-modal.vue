<template>
    <div class="e-invest w-full">
      <m-modal v-if="orderType == 'init_btc' || orderType == 'btc'"  bgBasic @close="closeModal" full-screen v-model="$app.store.user.isInvestModalShow.show"> <!--v-if="orderType == 'init_btc' || orderType == 'btc'"-->
      ...
      <!-- REINVEST -->
      <m-modal v-else-if="orderType !== 'init_btc' || orderType == 'usdt'" bgBasic @close="closeModal" full-screen v-model="$app.store.user.isInvestModalShow.show"> <!---->
        <div class="e-invest__invest flex flex-col justify-end items-start"> <!--max-w-[375px]-->
            <header class="e-invest__invest-text flex items-center font-medium text-center whitespace-nowrap"> <!--gap-4-->
