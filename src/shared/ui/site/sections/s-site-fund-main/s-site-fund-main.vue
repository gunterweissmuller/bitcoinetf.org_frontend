<template>
  <section class="s-site-fund-main">
    <h1 v-html="data.title" class="s-site-fund-main__title title-site-h2"/>
    <div class="s-site-fund-main__img">
...
<style src="./s-site-fund-main.scss" lang="scss"/>
