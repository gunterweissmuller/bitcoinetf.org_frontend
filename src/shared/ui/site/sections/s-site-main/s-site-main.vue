<template>
  <section class="s-site-main">
    <div class="l-site-dark">
      <div class="s-site-main__wrapper">
        <div class="s-site-main__img">
          <img src="/img/site-dark/s-site-main/1.png" />
        </div>
        <div class="s-site-main__info">
          <h1 v-html="data.title" class="s-site-main__title title-site-h1" />
          <m-slider
            ...
            <template #slides>
              <swiper-slide class="s-site-main__item">
                <div class="s-site-main__item-value">
                  ...
                  {{ $app.filters.rounded($app.store.user.statistic?.dividends_earned_btc, 5) }}
                </div>
                <div class="s-site-main__item-description">Total Dividends Paid</div>
              </swiper-slide>
              <swiper-slide class="s-site-main__item">
                <div
                ...
                <div class="s-site-main__item-description">BTC in Reserve Fund</div>
              </swiper-slide>
              <swiper-slide class="s-site-main__item">
                <div class="s-site-main__item-value">${{ $app.filters.rounded(fundTotalUsd, 2) }}</div>
                <div class="s-site-main__item-description">Assets Under Management</div>
              </swiper-slide>
            </template>
          </m-slider>
        </div>
        <div class="s-site-main__calculator">
          <m-profit-calculator />
        </div>
      </div>
    </div>
