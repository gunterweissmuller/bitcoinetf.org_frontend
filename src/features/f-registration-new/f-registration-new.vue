<template>
  ...
  <div class="f-registration-new">
    ...
    <div class="f-registration-new__bg">
              ...
              <div class="flex flex-col items-center pb-12">
                  ...
                  <div v-for="method in methods" @click="method.onClick" class="f-registration-new__button">
                    <div class="f-registration-new__button-left">
                      <NuxtImg :src="method.img" width="18" height="14" class="f-registration-new__button-img-method" loading="lazy" />
                      {{method.name}}
                    </div>
                    <NuxtImg :src="$app.store.user.theme === 'dark' ? '/img/icons/mono/chevron-dark-right.svg' : '/img/icons/mono/chevron-right.svg'" width="18" height="18" class="f-registration-new__button-img-arrow" loading="lazy" />
                  </div>
